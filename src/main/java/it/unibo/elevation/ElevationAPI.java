...
public interface ElevationAPI {
     ...
     */
    double getElevation(double lat, double lon) throws Exception;
     ...
     * @return The elevation of given point
     */
    double getElevation(GeoPoint p) throws Exception;
     ...
     */
    void setElevation(GeoPoint point) throws Exception;
     ...
     * @throws Exception Exceptions thrown by fetching data
     */
    List<GeoPoint> getElevations(List<GeoPoint> points) throws Exception;
     ...
     * @throws Exception Exceptions thrown by fetching data
     */
    void setElevations(List<GeoPoint> points) throws Exception;
     ...
     * @throws Exception Exceptions thrown by fetching data
     */
    List<GeoPoint> getElevations(String polyline) throws Exception;
